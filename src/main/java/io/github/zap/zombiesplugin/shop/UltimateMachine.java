...
public class UltimateMachine extends ButtonShop {

	public UltimateMachine(GameManager gameManager, boolean requiresPower, int cost, SoundFx purchaseSuccessSound, Block button, Location hologramLocation, String perkName) {
